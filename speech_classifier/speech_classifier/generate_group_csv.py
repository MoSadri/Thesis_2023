...
data_name = 'lgbt' # 3000 trans, 3000 gay, 3000 lesbian, 500 black, 500 women
...
num_targeted_black = 500 # Max 22899
num_targeted_white = 0 # Max 9797
num_targeted_woman = 500 # Max 27889
num_targeted_transgender = 3000 # 3326 + 4703 + 2611, combined transgender men + unspecified + women, there may be overlap
num_targeted_gay = 3000 # Max 15465
num_targeted_lesbian = 3000 # Max 6883
...
# Example usage
source_csv_path = "../data/berkeley_speech_dataset.csv"
destination_csv_path = f'../data/{data_name}_dataset.csv'
